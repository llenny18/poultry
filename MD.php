...
This is the Home File (md.php)
Contents:
1. Records of investment based on type of Medicines and Vitamins
...
$records = $recordbills->fetchRecords(2);
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Medicines & Vitamins Investment Record</h4><a href="addrecord.php"><i class="fa fa-user-plus m-2"></i>Add Investment Record</a></h4>
