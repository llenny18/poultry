                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="record.php"><i class="ti-receipt"></i> <span>Records of Profits</span></a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">User Admin <i class="fa fa-angle-down"></i></h4>
