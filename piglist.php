                                    ...
                                    <table id="dataTable3" class="text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="editpiglist.php?pid=<?= $listnow['HouseID']; ?>"><i class="fa fa-pencil-square m-1"></i>Edit</a> | <a href="disapigs.php?pid=<?= $listnow['HouseID']; ?>&processType=piglist"><i class="fa fa-user-times m-1"></i>Disable</a></td>
                                                </tr>
                                                <?php } ?>
