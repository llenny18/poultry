...
This is the Home File (e-wages.php)
Contents:
1. Records of investment based on type of Wages
...
$records = $recordbills->fetchRecords(3);
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Employee Wages Investment Record</h4><a href="addrecord.php"><i class="fa fa-user-plus m-2"></i>Add Investment Record</a></h4>
